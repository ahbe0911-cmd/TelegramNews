...
/// Checks a proxy link from a channel before passing it to Android.
/// MTProto is used by the installed Telegram client, not by Telegram Web.
bool gozarValidMtprotoLink(String input) {
  ...
  final web = uri.scheme.toLowerCase() == 'https' &&
      ...
      uri.path.replaceFirst(RegExp(r'/+ An optional MTProto
...
class _GozarTelegramWebState extends State<GozarTelegramWeb> {
  ...
  return RegExp(r'^[A-Za-z0-9.-]{1,253} An optional MTProto
/// handoff opens an installed Telegram client: it cannot proxy the website.
class GozarTelegramWeb extends StatefulWidget {
  final bool active;
...
class _GozarTelegramWebState extends State<GozarTelegramWeb> {
  ...
  Widget build(BuildContext context) => Directionality(
    ...
    child: Column(children: [
      ...
      RegExp(r'^[a-fA-F0-9]{32,512} An optional MTProto
/// handoff opens an installed Telegram client: it cannot proxy the website.
class GozarTelegramWeb extends StatefulWidget {
  final bool active;
